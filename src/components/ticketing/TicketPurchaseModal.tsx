...
export const TicketPurchaseModal: React.FC<TicketPurchaseModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl max-h-[90vh] flex flex-col bg-slate-950/95 border border-white/15 rounded-2xl shadow-2xl shadow-cyan-950/50 text-slate-100 overflow-hidden">
        {/* Header */}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Instant digital boarding pass with 30s rolling security QR
              </p>
            </div>
          </div>
            ...
            >
              {isPurchasing ? (
                ...
                <>
                  ...
                  Pay {formatRupiah(fareResult.totalFareRp)}
                </>
              )}
            </button>
          </div>
